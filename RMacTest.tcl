...
set opt(layers)                         1
set opt(x)	                	    13  ;# X dimension of the topography
set opt(y)	                        12 ;# Y dimension of the topography
set opt(z)                          14
set opt(seed)	                	348.88
...
$a_(0) cmd set-target-x 0
$a_(0) cmd set-target-y 0
$a_(0) cmd set-target-z 0
$a_(0) set data_rate_ 0.05
